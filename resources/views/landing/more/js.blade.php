      ...
      <div class="container-fluid mw-block">
        <div class="row  body-vector container-fluid">
          ...
          <div class="row marker mt-5">
            <img class="more_information_image" src="{{ asset("public/img/landing/js_more.png") }}" alt="">
            <div class="title-content">
              <h1 class="stack_title">Javascript</h1>
              <h2 class="stack_subtitle">Браузерное программирование</h2>
            </div>
          </div>
          <div class="information-text">
            <h1>Научитесь вместе с нами "оживлять" ваши сайты,
                делать сложную
                анимацию,
