      ...
      <div class="container-fluid mw-block">
        <div class="row body-vector container-fluid">
          ...
          <div class="row mt-5 marker">
            <img class="more_information_image" src="{{ asset("public/img/landing/java.png") }}" alt="">
            <div class="title-content">
              <h1 class="stack_title">Java</h1>
              <h2 class="stack_subtitle">Программирование</h2>
            </div>
          </div>
          <div class="information-text">
            <h1> Идеальный вариант для тех, кто хочет легко и
                 быстро войти в IT
                 !
