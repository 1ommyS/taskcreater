...
@section("title") Unity 3D @endsection
@section("content")
      ...
      <div class="container-fluid mw-block">
        <div class="row body-vector container-fluid">
          ...
          <div class="row mt-5 marker">
            <img class="more_information_image" src="{{ asset("public/img/landing/unity_more.png") }}" alt="">
            <div class="title-content">
              <h1 class="stack_title">Unity 3D</h1>
              <h2 class="stack_subtitle">Разработка игр</h2>
            </div>
          </div>
          <div class="information-text">
            <h1> Хотите доказать всем, что на играх можно
                 заработать? Станьте
