...
@section("title") .NET C# @endsection
@section("content")
    ...
    <section class="starter sect">
      <div class="container-fluid mw-block">
        <div class="row body-vector container-fluid">
          ...
          <div class="row marker mt-5">
            <img class="more_information_image" src="{{ asset("public/img/landing/net_more.png") }}" alt="">
            <div class="title-content">
              <h1 class="stack_title">.NET C#</h1>
              <h2 class="stack_subtitle">Разработка программ для бизнеса</h2>
            </div>
          </div>
          <div class="information-text">
            <h1> Всегда было интересно, что происходит при переводе денег с карты на
                 карту? Станьте
      ...
      <div class="format-medium more">
        <div class="container-fluid mw-block">
          <div class="information body-vector row  marker container-fluid">
