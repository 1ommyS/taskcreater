...
@section("title") HTML и CSS @endsection
@section("content")
  ...
  <section>
    ...
    <section class="starter sect">
      <div class="container-fluid mw-block">
        <div class="row body-vector container-fluid">
          ...
          <div class="row mt-5 marker">
            <img class="more_information_image" src="{{ asset("public/img/landing/web_more_image.png") }}" alt="">
            <div class="title-content">
              <h1 class="stack_title">HTML и CSS</h1>
              <h2 class="stack_subtitle">Верстка сайтов</h2>
            </div>
          </div>
          <div class="information-text">
            <h1>Научитесь верстать вместе с нами лендинги,
                сайт-визитки и
                корпоративные сайты.
            </h1>
          </div>
      ...
      <div class="format more">
        <div class="container-fluid mw-block">
          <div class="row body-vector container-fluid marker">
      ...
      <div class="format-medium  more">
        <div class="container-fluid mw-block">
          <div class="information body-vector row container-fluid ">
            <h1 class="format_lessons_title" style="padding-top: 15px;">Стоимость занятий: </h1>
            <div class="row  marker format-space-between">
              <div class="col-lg-4">
                <p class="information-lessons">
