...
@section("title") PHP + MySQL @endsection
@section("content")
  ...
  <section>
    <section class="starter sect">
      <div class="container-fluid mw-block">
        <div class="row body-vector container-fluid">
          ...
          <div class="row mt-5 marker">
            <img class="more_information_image" src="{{ asset("public/img/landing/web_light_blue.png") }}" alt="">
            <div class="title-content">
              <h1 class="stack_title">PHP + MySQL</h1>
              <h2 class="stack_subtitle">Серверное программирование</h2>
            </div>
          </div>
          <div class="information-text">
            <h1> Создавайте свои интернет-магазины и веб-сервисы
                 вместе с нами!
            </h1>
          </div>
      ...
      <div class="format more">
        <div class="container-fluid mw-block">
          <div class="row body-vector marker container-fluid">
      ...
      <div class="format-medium more">
        <div class="container-fluid mw-block">
          <div class="information marker body-vector row container-fluid">
